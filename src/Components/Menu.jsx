    ...
    return (
      <div className="w-full h-16 p-3 flex items-center justify-between bg-transparent backdrop-blur-2xl absolute">
        ...
        <div className="Busca w-96 h-10 flex items-center justify-center">
          <input type="text" placeholder="Procurar filme" className="w-full h-full bg-gray-700 outline-0 p-4 text-white placeholder:text-white rounded-bl-2xl rounded-tl-2xl"/>
