      ...
      <div className="w-full h-16 p-3 flex items-center justify-between bg-transparent backdrop-blur-2xl fixed">
        ...
        <div className="Busca w-96 h-10 flex items-center justify-center">
          <input
            ...
            className="w-full h-full bg-gray-800 outline-0 p-4 text-white placeholder:text-white rounded-bl-2xl rounded-tl-2xl border-2 border-emerald-500"
          />
        ...
        <button className="w-29 h-11 flex items-center justify-center gap-2 rounded-2xl bg-zinc-900 text-emerald-500 active:bg-zinc-800 transition-all duration-150 border-2 border-zinc-700">
